...
namespace OrderWinForm
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            order = new Order("啦啦啦", "1", 100,100);
            order = new Order("小魔仙", "2", 2,500);
            order = new Order("古娜拉黑暗之神", "4", 2,300);
            order = new Order("张", "1", 2,400);
            order = new Order("李霸天", "2", 2,400);
            order = new Order("娃哈哈", "0", 2,2000);
            order = new Order("呵呵哒", "5", 100,400);
            order = new Order("么么哒", "2", 2,200);

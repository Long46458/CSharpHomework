...
namespace OrderWinForm
{
    ...
    public class OrderDetails
    {
        ...
        public OrderDetails(string customerName = null, string itemName = null, int count = 0, int price = 0)
        {
            this.Count = count;
    ...
    public class Order
    {
        ...
        public Order(string customerName, string itemName, int count, int price)
        {
            order = new OrderDetails(customerName, itemName, count, price);

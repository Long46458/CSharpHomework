    ...
    public class OrderService
    {
        ...
        public void IntoOrder()
        {
            ...
            else
            {
                ...
                while (Temp)
                {
                    Console.WriteLine("输入1：添加订单条目");
                    Console.WriteLine("输入2：删除订单条目");
                    Console.WriteLine("输入3：筛选价格");
                    Console.WriteLine("输入-1：返回菜单");
        ...
        public OrderService()
        {
            ...
            {
                Console.WriteLine("输入1：添加订单");
                Console.WriteLine("输入2：删除订单 ");
                Console.WriteLine("输入3:查找订单");
                Console.WriteLine("输入4：输出订单");
                Console.WriteLine("输入5:进入订单");
                Console.WriteLine("输入-1：结束");
